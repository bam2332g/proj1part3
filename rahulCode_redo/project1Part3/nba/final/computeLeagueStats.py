...
with open("nbaPlayerInfo") as f:
	...
	avgYrsOfExp=totalExp/385.0
	avgAgeOfPlayer=totalAgePlayer/385.0
	totalAgePlayer=0
	for key in ageOfTeam:
		totalAgePlayer+=ageOfTeam[key][0]/ageOfTeam[key][1]
	avgAgeOfTeam=totalAgePlayer/30.0
